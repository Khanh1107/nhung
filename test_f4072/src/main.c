...
int temperature[] = {19, 30, 33, 35, 27, 33, 27, 29, 37};
...
{
  trace_puts("Chuong Trinh Dieu Khien Den");
  trace_puts("Nhiet do > 30 tien hanh bat den, Nhiet do < 30 tat den!");
  ...
  while (1)
    {
      ...
      if (temperature[seconds % 5] > 30) {
        ...
        trace_puts(" LED XANH BAT!");
      } else {
        blink_led_off(); // Turn off the LED
        trace_puts(" LED XANH TAT!");
      }
    }
}
